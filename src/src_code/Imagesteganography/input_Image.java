...
public class input_Image extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("ENTER_IMAGE_PATH");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String s,s2="just to differentiate input_Text string parameter";
        s=jTextField1.getText();
        this.setVisible(false);
        new steganographyUI(s,s2).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(input_Image.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
